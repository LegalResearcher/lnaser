    ...
    return (
      <div className="flex items-center gap-2">
        <Button
          ...
          className="bg-accent-gold text-navy hover:bg-accent-gold/90 gap-2"
        >
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      <Button
        ...
        className="bg-[#1877F2] hover:bg-[#1877F2]/90 border-none text-white"
      ...
      <Button
        ...
        className="bg-black hover:bg-black/90 border-none text-white"
      ...
      <Button
        ...
        className="bg-[#25D366] hover:bg-[#25D366]/90 border-none text-white"
      ...
      <Button
        ...
        className="bg-[#0088cc] hover:bg-[#0088cc]/90 border-none text-white"
